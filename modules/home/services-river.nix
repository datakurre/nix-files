...
let
  ...
  # display manager standalone). Must live here, not in the top-level
  # home-configuration.nix, since that file is only used by the standalone
  # "atsoukka" homeConfiguration -- NixOS machines wire home-manager through
