...
The standalone `atsoukka` Home Manager profile passes the trackball directly to
River/libinput, so button release is not delayed or synthesized by a userspace
filter. Apply it with:
